...
public class CDlinkedList<T extends Comparable<T>> implements Iterable<T> {
    ...
    public T removeFirst() {
        ...
        if (head.next == head) {
            ...
            // Set the last element to the head
            DNode<T> last = head.prev;
            // Set the head to the next element
            head = head.next;
            // Set the last element's next to the head
            last.next = head;
            // Set the head's previous to the last element
            head.prev = last;
        }
    ...
    public Iterator<T> iterator() {
        return new CDlinkedListIterator();
    }

    private class CDlinkedListIterator implements Iterator<T> {
        DNode<T> curr = head;
